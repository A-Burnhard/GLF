"""
Django settings for GLF project.
...
WSGI_APPLICATION = 'GLF.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://*.glf-test.up.railway.app/','https://glf-test.up.railway.app/admin']
